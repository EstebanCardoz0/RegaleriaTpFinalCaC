...
<html lang="es">
    ...
    <head>
        ...
        <title>Iniciar Sesiï¿½n - Regalerï¿½a</title>
        <!-- Boostrap-->
    ...
    <body>
        ...
        <div class="row mt-5 cortes">
            <div class="fuente fs-6 text-center m-1 text-white">
                Grupo: Regaleria - 2023. Integrantes: Tammy, Vazques - Esteban, Carmona - Evans, Ricardo - Walter,
                Catellan
                - Chico, Rodrigo.
            </div>
        </div>
        ...
        <div class="container fuente">
            <div class="row">
                ...
                <div class="col-sm-6 offset-sm-3">
                    ...
                    <form class="mt-3" action="../controller/checkLogin.jsp" method="post">

                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label fs-6">Dirección de correo</label>
                            <input type="email" name="user" class="form-control" placeholder="Ej.: tunombre@email.com"
                                   id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>

                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label fs-6">Contraseña</label>
            ...
            <div class="footer">
                <div class="container-fluid">
                    <div class="row ">
                        ...
                        <div class="col-4">
                            <h4 class="footer-title font-body text-uppercase fuente fs-6 text-center">Navegaciï¿½n</h4>
                        ...
                        <div class="col-4">
                            <h4 class="footer-title font-body text-uppercase fuente fs-6 text-center">Medios de pago
                            </h4>
