			...
			<div class="carousel-inner">
					...
					<div class="carousel-caption d-md-block">
						<div class="row">
							...
							<div class="col-12 col-lg-8 text-center text-lg-end">
								...
								<p>El termo y mate que estabas buscando est� ac�</p>
								<div class="lg-4">
									<a href="index.html#Termos" class="btn btn-outline-light">Ver
										m�s</a> <a href="#" class="btn button fuente fs-6"
				...
				<div class="carousel-item">
					...
					<div class="carousel-caption text-center text-lg-end d-md-block">
						...
						<p>Miles de modelos para todo el mundo, encontr� ac� los
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text text-center fuente-descripcion">Las
							Oreiro. Cartera simil cuero, de excelente calidad</p>
						<a href="#" class="btn button fuente fs-6 d-block mx-auto"
							onclick="agregarAlCarritoYMostrar('Cartera Las Oreiro - marr�n', 14600)">Agregar
							al carrito</a>
					</div>
				</div>
			</div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text text-center fuente-descripcion">Las
							Oreiro. Mochila simil cuero, de excelente calidad</p>
						<a href="#" class="btn button fuente fs-6 d-block mx-auto"
							onclick="agregarAlCarritoYMostrar('Mochila - Las Oreiro marr�n', 15200)">Agregar
							al carrito</a>
					</div>
				</div>
			</div>
		...
		<div class="footer">
			<div class="container-fluid">
				<div class="row ">
					...
					<div class="col-4">
						<h4
							class="footer-title font-body text-uppercase fuente fs-6 text-center">Navegaci�n</h4>
